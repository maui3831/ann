...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train a perceptron for AND or NAND gate.")
    parser.add_argument('--gate', type=str, choices=['and', 'nand'], default='and', help='Logic gate to train (and or nand)')
